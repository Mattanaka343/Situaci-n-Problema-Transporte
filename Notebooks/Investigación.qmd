...
- ¿Cuál es la probabilidad de que una mujer joven (adultez joven y adolscencia) de estrato social alto use la bicicleta?
```{r}
bn_mle = bn.fit(dag, data =data, method = 'mle')
cpquery(bn_mle,(V=='7'),((S=='2')&((E=='2')|(E=='1'))&(C=='4')))
```

  - La probabilidad de encontrar un evento de este tipo es bastante baja, siendo de alrededor de 1.3% 
