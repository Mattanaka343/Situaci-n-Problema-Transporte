...
Adicionalmente los datos usados para esta investigación provienen de Instituto Nacional de Estadística y Geografía, y su Encuesta Origen Destino en Hogares de la Zona Metropolitana del Valle de México (EOD) 2017 [link]


## Aplicación

### Modelación de DAG basada en estudios

Para construir la DAG se consultaron varios recursos y artículos que describieran la relación entre las variables seleccionadas para el modelado, estos estudios si bien varían entre varios países en distintos niveles de desarrollo, otorgan una perspectiva generalizada que servirá como base para describir las conductas que podemos observar en el mundo y aplicarlas a nuestra colección de datos.
